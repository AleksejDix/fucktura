export default {
  ...
  'About description':
    'Crea facturas, presupuestos y recordatorios. Local, sin conexión, sin nube.',
  File: 'Archivo',
  Document: 'Documento',
  View: 'Vista',
  ...
  'Browser not supported — please use Chrome, Edge, Brave, or another Chromium-based browser.':
    'Navegador no compatible — use Chrome, Edge, Brave u otro navegador basado en Chromium.',
  ...
  'This app stores your invoices as real files on your disk. It needs the File System Access API, which is only available in Chromium-based browsers.':
    'Esta aplicación guarda sus facturas como archivos reales en el disco. Necesita la File System Access API, que solo está disponible en navegadores basados en Chromium.',
  ...
  'Your invoices, clients, and positions will be saved as JSON files in the folder you pick. You can open them in Finder, back them up, or sync them via iCloud or Dropbox.':
    'Sus facturas, clientes y posiciones se guardarán como archivos JSON en la carpeta que elija. Puede abrirlos en Finder, hacer copias de seguridad o sincronizarlos con iCloud o Dropbox.',
