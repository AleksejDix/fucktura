<template>
  ...
  <!-- Needs folder pick -->
  <div
    v-else-if="folder.state === 'needs-pick' || folder.state === 'picking'"
    class="h-screen flex items-center justify-center p-8"
  >
  ...
  <!-- Loading -->
  <div
    v-else-if="folder.state === 'loading' || folder.state === 'init'"
